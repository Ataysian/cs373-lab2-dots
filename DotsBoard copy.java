...
public class DotsBoard {
    ...
    */
	...
	if(board[0][0] == 0){
		...
		if(whoseTurn) nextBoard[0][0] = 2;
		else nextBoard[0][0] = 1;
		madeMove = true;
	    }
	}
	if(board[0][1] == 0){
	    if(edges[1][2]==1 && edges[1][4]==1 && edges[5][4]==1 && edges[5][2]==1){
		if(whoseTurn) nextBoard[0][1] = 2;
		else nextBoard[0][1] = 1;
		madeMove = true;
	    }
	}
	if(board[1][0] == 0){
	    if(edges[3][4]==1 && edges[3][6]==1 && edges[7][6]==1 && edges[7][4]==1){
		if(whoseTurn) nextBoard[1][0] = 2;
		else nextBoard[1][0] = 1;
		madeMove = true;
	    }
	}
	if(board[1][1] == 0){
	    if(edges[4][5]==1 && edges[4][7]==1 && edges[8][7]==1 && edges[8][5]==1){
		if(whoseTurn) nextBoard[1][1] = 2;
		else nextBoard[1][1] = 1;
		madeMove = true;
	    }
	}
	return madeMove;
	...
	DotsBoard otherBoard = (DotsBoard) o;
	for(int x = 0; x < 9; x++){
	    for(int y = 0; y < 9; y++){
